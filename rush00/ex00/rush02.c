...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/02/02 16:55:47 by rkiwi             #+#    #+#             */
/*   Updated: 2020/02/02 16:55:49 by rkiwi            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_body(int i, int j, char *first, char *second)
{
	int count_i;
	int count_j;
